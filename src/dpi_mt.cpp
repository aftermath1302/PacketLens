...
private:
    ...
    void classifyFlow(Packet& pkt, FlowEntry& flow) {
        ...
        // Port-based fallback (but not marking as classified - might get SNI later)
...
void printUsage(const char* prog) {
    std::cout << R"(
DPI Engine Multi-threaded Deep Packet Inspection
========================================================
